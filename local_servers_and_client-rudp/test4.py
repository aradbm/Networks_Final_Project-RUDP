...
if __name__ == "__main__":
    """
    In test 4 we test the congection control. 
    We change the packet loss of the socket to 1.0(you may change in line 109), and we show that the 
    image never succeeds transfering, note that to stop the test it should be aborted manually by the ide or ctrl+c.
    ...
    print("Test4 passed successfuly")